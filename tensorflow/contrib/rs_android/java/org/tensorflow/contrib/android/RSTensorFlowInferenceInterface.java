 ...
 * */
public class RSTensorFlowInferenceInterface {
  private static final String TAG = "RSTensorFlowInferenceInterface";
  ...
  public RSTensorFlowInferenceInterface() {
    ...
    try {
      ...
      try {
        System.loadLibrary("rstensorflow_inference");
